...
**Example:** `./newrelic-cloud set-up-lambda-integration --nr-account-id account_id --linked-account-name "myt-test-account" --aws-role-policy "NewRelicLambdaPolicy" --nr-api-key abcdef12234567 --nr-license-key abcdef12345 --regions eu-west-1 eu-west-2`
